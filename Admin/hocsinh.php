...
<body>
            ...
            <div class="box_fun">
                ...
                <form class="" action="" method="post">
                    <div class="box_content">
                        ...
                        <div class="add_gv" style="width: 100%">
                            <button type="button" id="add_hs">Thêm mới</button>
                        </div>                       
        ...
        <div class="menu">
            ...
            <div class="chucnang">
                    <div class="chucnangchinh">
                        ...
                        <input type="button" value="Thông tin chi tiết" id="detail_btn">
    ...
    <script>   
        ...
        document.getElementById('add_hocsinh').onclick = function(){
            ...
            setTimeout(function(){ search('timkiem_hocsinh.php',document.getElementById('sel_search').value,document.getElementById('search').value); }, 300);                    
        }
        
        document.getElementById('add_hs').onclick = function(){
            var mahs = document.getElementById('MaHS');
            var tenhs = document.getElementById('TenHS');
            var ngaysinh = document.getElementById('NgaySinh');
            var gioitinh = document.getElementById('GioiTinh')
            ...
            var phuhuynh = document.getElementById('PhuHuynh');
            var sdt = document.getElementById('SDT');
            var get = "MaHS=" + mahs.value + "&TenHS=" + tenhs.value + "&NgaySinh=" + ngaysinh.value + "&MaLop=&GioiTinh=" +  gioitinh.value + "&DiaChi=" + diachi.value + "&PhuHuynh=" + phuhuynh.value + "&SDT=" + sdt.value; 
